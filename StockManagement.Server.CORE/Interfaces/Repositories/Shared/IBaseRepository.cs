...
namespace StockManagement.Server.CORE.Interfaces.Repositories.Shared
{
    public interface IBaseRepository<T> where T : class
    {
        ...
        IEnumerable<T> FindAllIQuarable(Expression<Func<T, bool>> criteria, string[] includes = null);
        ...
        Task<T> FirstAsync(Expression<Func<T, bool>> expression = null, bool excludeDeleted = true);
